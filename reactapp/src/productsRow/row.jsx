            ...
            <ol className="list_style">
              ...
              >
                ...
                <span style={{ fontSize: "1.8rem" }}>
                  {parseInt(handleSubmit("total")) + 90}
                </span>
              </li>
              <li className="address">
                ...
                <div className="homeAddress">
                  <div>
                    <img src="/icons/tick.svg" style={{ float: "right" }} />
                  </div>
