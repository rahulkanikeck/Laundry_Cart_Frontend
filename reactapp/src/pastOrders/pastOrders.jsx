...
let url = "https://laundry-cart-backend-dbsk.onrender.com";
...
const PastOrders = ({ data }) => {
  ...
  const getService = (key) => {
    ...
    for (let i = 0; i < cart1.length; i++) {
      if (cart1[i].key === key) {
        if (cart1[i].hasOwnProperty("washing-machine"))
          serviceStr += "Washing   ";
      ...
      {summaryOn1 ? (
        <div id="summary">
          ...
          <div className="subheading">
            ...
            <div className="inline_hd">Phone:{viewdata.storePhone}</div>
          </div>
            ...
            <ol className="list_style">
              {viewdata.cart.map((data2) => (
                <li key={data.key} className="bottom_border">
                  <span className="inline_hd" style={{ width: "5vw" }}>
                    {data2.name}
                  </span>
                  <span className="inline_hd" style={{ width: "20vw" }}>
                    {getService(data2.key)}
                  </span>
              ...
              <li className="total_block">
                Sub Total: &nbsp;&nbsp;{parseInt(viewdata.price) - 90}
              </li>
              <li className="total_block1">Pickup Charges: 90</li>
              <li
                className="total_block"
                style={{
                  background: "#5861AE",
                  fontWeight: "bold",
                  fontSize: "25px",
              ...
              >
                Total: <span>{viewdata.price}</span>
              </li>
              ...
              <li className="corner" style={{ border: "none" }}>
                <button
                  ...
                  onClick={() => handleCancel(viewdata.orderId)}
                >
                  Cancel Order
                </button>
              </li>
